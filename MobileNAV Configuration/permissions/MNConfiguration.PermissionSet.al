...
permissionset 77780 "BJF MN Configuration"
{
    ...
    Permissions =
        codeunit "BJF Check Config Appearance" = X,
        codeunit "BJF Check Config Apply State" = X,
        codeunit "BJF Check Config Groups" = X,
        codeunit "BJF Check Config Layouts" = X,
        codeunit "BJF Check Config Master Data" = X,
        codeunit "BJF Check Config Page Rows" = X,
        codeunit "BJF Check Config Relations" = X,
        ...
        codeunit "BJF MN Appearance Mgt." = X,
        ...
        codeunit "BJF MN Filter Mgt." = X,
        codeunit "BJF MN Group Mgt." = X,
        codeunit "BJF MN Layout Mgt." = X,
        codeunit "BJF MN Master Data Mgt." = X,
        ...
        codeunit "BJF MN Relation Mgt." = X,
